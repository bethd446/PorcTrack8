...
- Name: navigation.spec.ts >> Navigation Principale >> Onglet Bandes → header correct
- Location: tests/e2e/navigation.spec.ts:68:3
...
Call log:
  - waiting for locator('ion-tab-button').locator('text=BANDES')

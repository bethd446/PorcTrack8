...
Suivi trésorerie K13 : 4 KPI + bloc CA synthèse (sparkline + 3 dernières ventes) + donut dépenses + transactions. HubTile vers Rapport financier en bas. FAB contextuel emerald (vente/dépense).

          ...
          <div key={asset.id} className="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                aria-label={`Générer ${asset.name}`}
                className="pressable p-2 bg-emerald-50 text-emerald-600 rounded-xl active:scale-95 transition-all disabled:opacity-50"
              >
            ...
            {generatedAssets[asset.id] ? (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="pressable w-full py-3 bg-emerald-900 text-white rounded-xl font-bold text-xs flex items-center justify-center gap-2"
                >
  ...
  return (
    <div className="p-4 space-y-6 pb-24">
        ...
        <div className="bg-white p-4 rounded-3xl border border-gray-100 shadow-sm space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="pressable px-4 py-2 bg-gray-100 text-gray-900 rounded-xl text-[10px] font-bold active:scale-95 transition-all"
            >
              CHANGER
            </button>
          </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex bg-gray-100 p-1 rounded-xl">
          <button
            ...
            className={cn("pressable flex-1 py-2 text-[10px] font-bold rounded-lg transition-all", syncMode === 'sheets' ? "bg-white text-emerald-700 shadow-sm" : "text-gray-500")}
          >
            GOOGLE SHEETS
          </button>
          <button
            onClick={() => setSyncMode('appsheet')}
            className={cn("pressable flex-1 py-2 text-[10px] font-bold rounded-lg transition-all", syncMode === 'appsheet' ? "bg-white text-emerald-700 shadow-sm" : "text-gray-500")}
          >
            APPSHEET API
          </button>
        </div>
      ...
      <div className="space-y-4">
        ...
        <button
          onClick={save}
          className="pressable w-full py-4 bg-emerald-700 text-white rounded-2xl font-bold text-sm shadow-lg active:scale-95 transition-transform"
        >
      ...
      <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-gray-100 space-y-4">
        ...
        <button
          ...
          className="pressable w-full py-4 bg-emerald-50 text-emerald-900 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 active:scale-95 transition-all"
        >
        ...
        <button
          ...
          className="pressable w-full py-4 bg-red-50 text-red-600 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 active:scale-95 transition-all"
        >
        ...
        <div className="space-y-3">
          {questions[step].options.map((opt, i) => (
            <button
              key={i}
              onClick={next}
              className="pressable w-full p-5 bg-white/10 border border-white/10 rounded-3xl text-left font-bold text-lg flex justify-between items-center group active:bg-white/20 transition-all"
            >
              {opt}

    ...
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100 px-6 py-4 flex justify-between items-center">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={cn(
            "pressable px-3 py-1.5 rounded-full flex items-center gap-2 transition-all border active:scale-95 disabled:opacity-50",
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className="pressable flex flex-col items-center gap-1 group relative"
            >
              <div className={cn(

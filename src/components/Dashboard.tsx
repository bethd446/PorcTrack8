  ...
  return (
    <div className="p-4 space-y-6 pb-24">
      ...
      <button 
        ...
        className="w-full py-4 bg-emerald-900 text-white rounded-2xl font-bold text-sm shadow-xl flex items-center justify-center gap-3 active:scale-95 transition-all disabled:opacity-50"
      >

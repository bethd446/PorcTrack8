...
- Name: navigation.spec.ts >> Navigation Principale >> Onglet Plus → header correct
- Location: tests/e2e/navigation.spec.ts:80:3
...
Call log:
  - waiting for locator('ion-tab-button').locator('text=PLUS')

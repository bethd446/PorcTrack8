...
- Name: navigation.spec.ts >> Navigation Principale >> Onglet Alertes → header correct
- Location: tests/e2e/navigation.spec.ts:74:3
...
Call log:
  - waiting for locator('ion-tab-button').locator('text=ALERTES')

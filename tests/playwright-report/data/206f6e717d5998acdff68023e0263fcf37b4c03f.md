...
- Name: navigation.spec.ts >> Sous-pages >> Route inconnue → redirige ou affiche quelque chose
- Location: tests/e2e/navigation.spec.ts:169:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/route-inconnue
Call log:
  - navigating to "http://localhost:5173/route-inconnue", waiting until "load"

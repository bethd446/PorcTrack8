    ...
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <label className="space-y-1">
          ...
          <input className="w-full rounded border p-2" type="number" value={naissances} onChange={e => setNaissances(Number(e.target.value))} />
        </label>

        <label className="space-y-1">
          <div className="text-sm">Mortalité</div>
          <input className="w-full rounded border p-2" type="number" value={mortalite} onChange={e => setMortalite(Number(e.target.value))} />
        </label>
      ...
      <div className="flex gap-2">
        <button className="rounded bg-black text-white px-4 py-2" onClick={onSubmit} disabled={!canSubmit}>
          Enregistrer
        </button>
        <button className="rounded border px-4 py-2" onClick={onSync}>
          Synchroniser
        </button>
      </div>

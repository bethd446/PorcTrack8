...
const QuickAddVerratForm: React.FC<QuickAddVerratFormProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <>
      <IonModal isOpen={isOpen} onDidDismiss={handleClose} className="agritech-bottom-sheet pt-sheet-modal" aria-label="Ajouter un verrat">
        <div className="ion-page" style={{ position: 'relative', overflow: 'auto' }}>
          <form className="sheet" onSubmit={handleSubmit} noValidate aria-label="Création d'un verrat" style={{ position: 'relative', height: '100%', maxHeight: '100%' }}>
            ...
            <div className="sheet__body">
              <div className="field">
                <label className="field__label" htmlFor="add-verrat-code">CODE <span className="hint">auto-généré</span></label>
              ...
              <div className="field">
                <label className="field__label" htmlFor="add-verrat-boucle">BOUCLE <span className="req">requis</span></label>
              ...
              <div className="field">
                <label className="field__label" htmlFor="add-verrat-naissance">DATE NAISSANCE</label>
              ...
              <div className="field">
                <label className="field__label" htmlFor="add-verrat-origine">ORIGINE / LIGNÉE</label>
              ...
              <div className="field">
                <label className="field__label" htmlFor="add-verrat-ration">RATION <span className="hint">kg / jour</span></label>
            ...
            <footer className="sheet__foot">
              ...
              <button type="submit" className="btn btn--primary" disabled={saving || !isValid} aria-busy={saving} aria-label="Ajouter le verrat au troupeau">

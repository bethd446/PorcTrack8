...
- Name: navigation.spec.ts >> Navigation Principale >> Onglet Cheptel → header correct
- Location: tests/e2e/navigation.spec.ts:60:3
...
Call log:
  - waiting for locator('ion-tab-button').locator('text=CHEPTEL')
